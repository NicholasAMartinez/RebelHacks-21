    ...
    <div className="min-h-screen bg-slate-950 text-zinc-100">
      ...
      <header className="border-b border-white/10 px-4 py-12 sm:px-6">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-3 text-4xl font-bold text-white md:text-5xl">Clear Rules. Fair Pools.</h1>
        ...
        <div className="mx-auto max-w-6xl space-y-8">
          <section className="grid gap-6 md:grid-cols-2">
            <article className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-6">
              <h2 className="mb-4 text-2xl font-bold text-white">Upload and Describe</h2>
          ...
          <section className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-6">
            <h2 className="mb-4 text-2xl font-bold text-white">Gambling and Matching</h2>
          ...
          <section className="grid gap-6 md:grid-cols-2">
            <article className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-6">
              <h2 className="mb-4 text-2xl font-bold text-white">Meeting and Safety</h2>
              <p className="mb-4 text-zinc-300">
